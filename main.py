...
if __name__ == '__main__':
    ...
    wb = load_workbook(args.input)  # Carrega a planilha na memória.
    ...
    for col in sheet.iter_cols(1, column_count):  # retorna todas as colunas entre A e a última.
    ...
    wb.save(f'{args.input.replace(".xlsx", "")} - Formatado.xlsx')  # Salva a planilha no disco e a retira da memória.
